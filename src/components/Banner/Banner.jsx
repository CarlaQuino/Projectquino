          ...
          <div className="container">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 items-center">
              ...
              <div className="flex flex-col justify-center gap-6 sm:pt-0 lg:px-16">
                ...
                >
                  Explore all corners of The Philippines with us
                </h1>
                <p
                  data-aos="fade-up"
                  className="text-sm text-gray-500 tracking-wide leading-8"
                >
                  Embark on an unforgettable journey to the Philippines, a tropical paradise of over 7,000 islands. From pristine white-sand beaches and turquoise waters to lush mountains and vibrant cities, the Philippines offers something for everyone. Dive into its rich culture, savor mouthwatering local delicacies, and discover hidden gems with us as your guide. Whether it’s an adrenaline-filled adventure, a serene escape, or a cultural exploration you seek, let us take you on a trip to remember. Explore the Philippines with us and create memories that will last a lifetime!
                  <br />
                </p>
